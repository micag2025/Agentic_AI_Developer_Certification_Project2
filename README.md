...
- _Interactive Streamlit UI_: User-friendly interface for selecting, querying, and comparing publications  
...
- _Summary of differences_
- _Fact-checking content_  
- _Enrichment using AI agents_
- _Export to HTML and JSON for easy sharing or downstream processing_
...
```
 >_Note_ This repository includes a well-configured `.gitignore` file to keep your repository clean by preventing large, sensitive, or autogenerated files from being committed 
